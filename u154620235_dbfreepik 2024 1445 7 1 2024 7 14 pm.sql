...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 01, 2024 at 07:41 AM
...
CREATE TABLE `file_types` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `supported_file_extension` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`supported_file_extension`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
